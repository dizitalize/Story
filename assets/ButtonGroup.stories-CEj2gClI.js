import{j as e}from"./jsx-runtime-DF2Pcvd1.js";import{r as l}from"./index-B2-qRKKC.js";import{B as Oe}from"./Button-Sb-dFZaJ.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./classNames-2dOUpm6k.js";const ke=l.createContext(null),we=()=>{const r=l.useContext(ke);if(!r)throw new Error("ButtonGroupItem must be used within a ButtonGroup");return r},Me=r=>{const{value:G,defaultValue:I,onChange:f,exclusive:p,multiSelect:d,orientation:j,variant:h,size:x,disabled:o,fullWidth:b}=r,[y,S]=l.useState(()=>I!==void 0?I:d?[]:null),m=G!==void 0,s=m?G:y,[B,V]=l.useState([]),[_,k]=l.useState(null),v=l.useCallback(a=>{V(u=>u.includes(a)?u:[...u,a])},[]),O=l.useCallback(a=>{V(u=>u.filter(i=>i!==a))},[]),c=l.useCallback(a=>{let u;if(p)u=s===a?null:a;else if(d){const i=Array.isArray(s)?s:[];i.includes(a)?u=i.filter(z=>z!==a):u=[...i,a]}else{const i=Array.isArray(s)?s:[];i.includes(a)?u=i.filter(z=>z!==a):u=[...i,a]}m||S(u),f&&f(u)},[s,p,d,m,f]);return l.useEffect(()=>{_===null&&B.length>0&&k(B[0])},[B,_]),l.useMemo(()=>({value:s??null,onChange:c,orientation:j,variant:h,size:x,exclusive:p,multiSelect:d,disabled:o,fullWidth:b,registeredValues:B,registerValue:v,unregisterValue:O,focusedValue:_,setFocusedValue:k}),[s,c,j,h,x,p,d,o,b,B,v,O,_])},De="_buttonGroup_3sd6g_266",Le="_horizontal_3sd6g_273",Ee="_segmented_3sd6g_278",Re="_groupItem_3sd6g_278",Te="_selected_3sd6g_296",We="_vertical_3sd6g_308",qe="_fullWidth_3sd6g_343",Ae="_disabled_3sd6g_353",Fe="_contained_3sd6g_375",Pe="_outlined_3sd6g_388",Ne="_soft_3sd6g_400",Ue="_tertiary_3sd6g_411",He="_iconOnly_3sd6g_421",Ke="_sizeSm_3sd6g_426",Je="_sizeLg_3sd6g_429",g={"dark-mode":"_dark-mode_3sd6g_244",buttonGroup:De,horizontal:Le,segmented:Ee,groupItem:Re,selected:Te,vertical:We,fullWidth:qe,disabled:Ae,contained:Fe,outlined:Pe,soft:Ne,tertiary:Ue,iconOnly:He,sizeSm:Ke,sizeLg:Je},n=({id:r,value:G,defaultValue:I,onChange:f,orientation:p="horizontal",variant:d="contained",size:j="md",exclusive:h=!1,multiSelect:x=!1,disabled:o=!1,fullWidth:b=!1,className:y,"aria-label":S,children:m})=>{const s=Me({value:G,defaultValue:I,onChange:f,exclusive:h,multiSelect:x,orientation:p,variant:d,size:j,disabled:o,fullWidth:b}),B=[g.buttonGroup,g[p],d!=="contained"&&g.segmented,b&&g.fullWidth,o&&g.disabled,y].filter(Boolean).join(" "),V=h?"radiogroup":"group";return e.jsx(ke.Provider,{value:s,children:e.jsx("div",{id:r,className:B,role:V,"aria-label":S,"aria-disabled":o,"aria-orientation":p,children:m})})};n.displayName="ButtonGroup";n.__docgenInfo={description:"",methods:[],displayName:"ButtonGroup",props:{orientation:{defaultValue:{value:"'horizontal'",computed:!1},required:!1},variant:{defaultValue:{value:"'contained'",computed:!1},required:!1},size:{defaultValue:{value:"'md'",computed:!1},required:!1},exclusive:{defaultValue:{value:"false",computed:!1},required:!1},multiSelect:{defaultValue:{value:"false",computed:!1},required:!1},disabled:{defaultValue:{value:"false",computed:!1},required:!1},fullWidth:{defaultValue:{value:"false",computed:!1},required:!1}}};const t=({value:r,disabled:G=!1,icon:I,startIcon:f,endIcon:p,selected:d,className:j,onClick:h,children:x})=>{const o=we(),b=l.useRef(null),{registerValue:y,unregisterValue:S}=o;l.useEffect(()=>(y(r),()=>S(r)),[r,y,S]);const m=d!==void 0?d:Array.isArray(o.value)?o.value.includes(r):o.value===r,s=o.focusedValue===r,B=l.useCallback(v=>{!G&&!o.disabled&&(o.onChange(r),o.setFocusedValue(r),h&&h(v))},[G,o,r,h]),V=l.useCallback(v=>{const{orientation:O,registeredValues:c}=o,C=c.indexOf(r);let a=C,u=!1;if(O==="horizontal"?v.key==="ArrowRight"?(a=(C+1)%c.length,u=!0):v.key==="ArrowLeft"&&(a=(C-1+c.length)%c.length,u=!0):v.key==="ArrowDown"?(a=(C+1)%c.length,u=!0):v.key==="ArrowUp"&&(a=(C-1+c.length)%c.length,u=!0),u){v.preventDefault();const i=c[a];o.setFocusedValue(i);const z=document.querySelector(`[data-button-group-value="${i}"]`);z&&z.focus()}},[o,r]),_=[g.groupItem,g[o.variant],m&&g.selected,I&&!x&&g.iconOnly,j].filter(Boolean).join(" "),k=o.exclusive?{role:"radio","aria-checked":m}:o.multiSelect?{role:"checkbox","aria-checked":m}:{"aria-pressed":m};return e.jsx("div",{ref:b,className:_,children:e.jsx(Oe,{variant:o.variant,size:o.size,disabled:G||o.disabled,fullWidth:o.fullWidth,startIcon:I||f,endIcon:p,onClick:B,onKeyDown:V,tabIndex:s?0:-1,"data-button-group-value":r,...k,children:x})})};t.displayName="ButtonGroupItem";t.__docgenInfo={description:"",methods:[],displayName:"ButtonGroupItem",props:{value:{required:!0,tsType:{name:"string"},description:"Unique value for this button"},disabled:{required:!1,tsType:{name:"boolean"},description:`Disable this specific button
...
}`,...(ae=(ne=E.parameters)==null?void 0:ne.docs)==null?void 0:ae.source}}};var ue,le,se;R.parameters={...R.parameters,docs:{...(ue=R.parameters)==null?void 0:ue.docs,source:{originalSource:`{
  args: {
...
}`,...(se=(le=R.parameters)==null?void 0:le.docs)==null?void 0:se.source}}};var ie,de,ce;T.parameters={...T.parameters,docs:{...(ie=T.parameters)==null?void 0:ie.docs,source:{originalSource:`{
  args: {
    exclusive: true,
    defaultValue: 'grid',
...
}`,...(Ve=(Se=P.parameters)==null?void 0:Se.docs)==null?void 0:Ve.source}}};var _e,Ce,ze;N.parameters={...N.parameters,docs:{...(_e=N.parameters)==null?void 0:_e.docs,source:{originalSource:`{
  args: {
    orientation: 'vertical',
    fullWidth: true,
    variant: 'outlined',
