import{j as e}from"./jsx-runtime-DF2Pcvd1.js";import{r as l}from"./index-B2-qRKKC.js";import{d,t as B}from"./typography-Brmv3wtg.js";import{s as Q}from"./spacing-QHzs6Ru8.js";import{m as F}from"./motion-Doj7O8T4.js";import{T as o}from"./Typography-BdmfNA7_.js";import{B as ys}from"./Box-Beh14k55.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./classNames-2dOUpm6k.js";const p={primary:d.primary[500],success:d.success[600],warning:d.warning[900],error:d.danger[600],track:d.gray[300]},X=r=>{if(!r)return;if(/^(#|rgb|hsl)/.test(r))return r;const s=r.split(".");if(s.length===2){const[t,a]=s;if(t==="neutral"&&(a==="white"||a==="black"))return d.neutral[a];const n=d[t];if(n&&a in n)return n[a]}return r},hs={sm:40,md:80,lg:120},H={sm:3,md:4,lg:6},Y={rotate:`
