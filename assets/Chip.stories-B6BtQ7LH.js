import{j as e}from"./jsx-runtime-DF2Pcvd1.js";import{R as Le,r as Ee}from"./index-B2-qRKKC.js";import{A as y}from"./Avatar-30CLte5W.js";import{I as o}from"./Icon-dy69MN_5.js";import"./_commonjsHelpers-Cpj98o6Y.js";const Fe="_chip_145lk_265",t={"dark-mode":"_dark-mode_145lk_244",chip:Fe,"chip--small":"_chip--small_145lk_279","chip--medium":"_chip--medium_145lk_286","chip--large":"_chip--large_145lk_293","chip--contained":"_chip--contained_145lk_300","chip--disabled":"_chip--disabled_145lk_305","chip--outline":"_chip--outline_145lk_314","chip--soft":"_chip--soft_145lk_329","chip--tertiary":"_chip--tertiary_145lk_342","chip--selected":"_chip--selected_145lk_361","chip--shadow":"_chip--shadow_145lk_365","chip--border":"_chip--border_145lk_369","chip-avatar":"_chip-avatar_145lk_379","chip-dot":"_chip-dot_145lk_400","chip-dot--small":"_chip-dot--small_145lk_407","chip-dot--medium":"_chip-dot--medium_145lk_412","chip-dot--large":"_chip-dot--large_145lk_417","chip-icon":"_chip-icon_145lk_422","chip-content":"_chip-content_145lk_441","chip-remove":"_chip-remove_145lk_447"},a=Le.memo(({id:C,content:fe,variant:n="contained",size:b="medium",leadingIcon:j,trailingIcon:S,avatar:z,dot:xe=!1,dotColor:ye,disabled:_=!1,selectable:Ce=!1,selected:_e=!1,allowBorder:R=!1,allowShadow:Ie=!1,backgroundColor:we,textColor:be,borderColor:je,className:A,onClick:k,onRemove:I,...Se})=>{const[T,ze]=Ee.useState(_e),Re=w=>{_||(Ce&&ze(!T),k&&k(w))},Ae=w=>{w.stopPropagation(),I&&!_&&I()},ke=t[`chip--${b}`],Te=t[`chip--${n}`],r=[t.chip,ke,Te];_&&r.push(t["chip--disabled"]),T&&r.push(t["chip--selected"]),Ie&&r.push(t["chip--shadow"]),(R||n==="outline")&&r.push(t["chip--border"]),A&&r.push(A);const De=t[`chip-dot--${b}`],We=we||(n==="contained"?"var(--color-primary-600)":n==="soft"?"var(--color-primary-100)":n==="outline"?"transparent":n==="tertiary"?"var(--color-gray-100)":"var(--color-gray-50)"),Ne=be||(n==="contained"?"var(--color-white)":n==="soft"?"var(--color-primary-700)":n==="outline"?"var(--color-primary-600)":n==="tertiary"?"var(--color-gray-700)":"var(--color-gray-600)"),qe=je||(n==="outline"?"var(--color-primary-600)":"var(--color-gray-300)"),Be=ye||"var(--color-success-600)";return e.jsxs("div",{id:C,className:r.join(" "),style:{backgroundColor:We,color:Ne,borderColor:R||n==="outline"?qe:void 0},onClick:Re,...Se,children:[z&&e.jsx("span",{className:t["chip-avatar"],children:z}),xe&&e.jsx("span",{className:`${t["chip-dot"]} ${De}`,style:{backgroundColor:Be}}),j&&e.jsx("span",{className:t["chip-icon"],children:j}),e.jsx("span",{className:t["chip-content"],children:fe}),I?e.jsx("span",{className:t["chip-remove"],onClick:Ae,children:"×"}):S&&e.jsx("span",{className:t["chip-icon"],children:S})]})});a.__docgenInfo={description:"",methods:[],displayName:"Chip",props:{variant:{defaultValue:{value:'"contained"',computed:!1},required:!1},size:{defaultValue:{value:'"medium"',computed:!1},required:!1},dot:{defaultValue:{value:"false",computed:!1},required:!1},disabled:{defaultValue:{value:"false",computed:!1},required:!1},selectable:{defaultValue:{value:"false",computed:!1},required:!1},selected:{defaultValue:{value:"false",computed:!1},required:!1},allowBorder:{defaultValue:{value:"false",computed:!1},required:!1},allowShadow:{defaultValue:{value:"false",computed:!1},required:!1}}};const Je={title:"DataDisplay/Chip",component:a,tags:["autodocs"],parameters:{docs:{source:{type:"code"}}},argTypes:{size:{control:"radio",options:["small","medium","large"]},variant:{control:"radio",options:["outline","contained","soft","tertiary"]},backgroundColor:{control:"color"},textColor:{control:"color"},dotColor:{control:"color"},borderColor:{control:"color"},dot:{control:"boolean"},disabled:{control:"boolean"},selectable:{control:"boolean"},selected:{control:"boolean"},allowBorder:{control:"boolean"},allowShadow:{control:"boolean"},leadingIcon:{table:{disable:!0}},trailingIcon:{table:{disable:!0}},avatar:{table:{disable:!0}},onRemove:{table:{disable:!0}},onClick:{table:{disable:!0}}}},i=C=>e.jsx(a,{...C});i.args={content:"Chip",variant:"contained",size:"medium"};const d=()=>e.jsxs("div",{style:{display:"flex",gap:12,flexWrap:"wrap"},children:[e.jsx(a,{content:"Outline",variant:"outline"}),e.jsx(a,{content:"Contained",variant:"contained"}),e.jsx(a,{content:"Soft",variant:"soft"}),e.jsx(a,{content:"Tertiary",variant:"tertiary"})]}),p=()=>e.jsxs("div",{style:{display:"flex",gap:12,alignItems:"center"},children:[e.jsx(a,{content:"Small",size:"small",variant:"contained"}),e.jsx(a,{content:"Medium",size:"medium",variant:"contained"}),e.jsx(a,{content:"Large",size:"large",variant:"contained"})]}),m=()=>e.jsxs("div",{style:{display:"flex",gap:12,flexWrap:"wrap"},children:[e.jsx(a,{content:"Active",dot:!0,variant:"contained"}),e.jsx(a,{content:"Online",dot:!0,dotColor:"var(--color-success-600)",variant:"soft"}),e.jsx(a,{content:"Offline",dot:!0,dotColor:"var(--color-gray-500)",variant:"outline"})]}),s=()=>e.jsxs("div",{style:{display:"flex",gap:12,flexWrap:"wrap"},children:[e.jsx(a,{content:"John Doe",avatar:e.jsx(y,{initials:"JD",size:"xs",shape:"circle"}),variant:"contained"}),e.jsx(a,{content:"Alice Smith",avatar:e.jsx(y,{initials:"AS",size:"xs",shape:"circle"}),variant:"soft"}),e.jsx(a,{content:"Bob Lee",avatar:e.jsx(y,{initials:"BL",size:"xs",shape:"circle"}),variant:"outline"})]});s.parameters={docs:{source:{code:`<Chip 
  content="John Doe" 
...
<Chip 
  ...
  variant="outline" 
/>`}}};const l=()=>e.jsxs("div",{style:{display:"flex",gap:12,flexWrap:"wrap"},children:[e.jsx(a,{content:"Add",leadingIcon:e.jsx(o,{name:"AddIcon",variant:"regular",size:16}),variant:"contained"}),e.jsx(a,{content:"Delete",trailingIcon:e.jsx(o,{name:"DeleteIcon",variant:"regular",size:16}),variant:"soft"}),e.jsx(a,{content:"Save",leadingIcon:e.jsx(o,{name:"FolderFilledIcon",variant:"regular",size:16}),trailingIcon:e.jsx(o,{name:"ArrowRightNormalIcon",variant:"regular",size:16}),variant:"outline"})]});l.parameters={docs:{source:{code:`<Chip 
  content="Add" 
...
| "tertiary"`,elements:[{name:"literal",value:'"outline"'},{name:"literal",value:'"contained"'},{name:"literal",value:'"soft"'},{name:"literal",value:'"tertiary"'}]},description:""},size:{required:!1,tsType:{name:"union",raw:'"small" | "medium" | "large"',elements:[{name:"literal",value:'"small"'},{name:"literal",value:'"medium"'},{name:"literal",value:'"large"'}]},description:""},leadingIcon:{required:!1,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""},trailingIcon:{required:!1,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""},avatar:{required:!1,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""},dot:{required:!1,tsType:{name:"boolean"},description:""},dotColor:{required:!1,tsType:{name:"string"},description:""},selectable:{required:!1,tsType:{name:"boolean"},description:""},selected:{required:!1,tsType:{name:"boolean"},description:""},allowBorder:{required:!1,tsType:{name:"boolean"},description:""},allowShadow:{required:!1,tsType:{name:"boolean"},description:""},backgroundColor:{required:!1,tsType:{name:"string"},description:""},textColor:{required:!1,tsType:{name:"string"},description:""},borderColor:{required:!1,tsType:{name:"string"},description:""},onRemove:{required:!1,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""}},composes:["Omit"]};d.__docgenInfo={description:"",methods:[],displayName:"AllVariants"};p.__docgenInfo={description:"",methods:[],displayName:"AllSizes"};m.__docgenInfo={description:"",methods:[],displayName:"WithDot"};s.__docgenInfo={description:"",methods:[],displayName:"WithAvatar"};l.__docgenInfo={description:"",methods:[],displayName:"WithIcons"};u.__docgenInfo={description:"",methods:[],displayName:"Selectable"};v.__docgenInfo={description:"",methods:[],displayName:"Removable"};h.__docgenInfo={description:"",methods:[],displayName:"Disabled"};g.__docgenInfo={description:"",methods:[],displayName:"LongContent"};f.__docgenInfo={description:"",methods:[],displayName:"ColorControl"};x.__docgenInfo={description:"",methods:[],displayName:"WithShadowAndBorder"};c.__docgenInfo={description:"",methods:[],displayName:"RealWorldUsage"};var D,W,N;i.parameters={...i.parameters,docs:{...(D=i.parameters)==null?void 0:D.docs,source:{originalSource:"(args: ChipProps) => <Chip {...args} />",...(N=(W=i.parameters)==null?void 0:W.docs)==null?void 0:N.source}}};var q,B,L;d.parameters={...d.parameters,docs:{...(q=d.parameters)==null?void 0:q.docs,source:{originalSource:`() => <div style={{
  ...
  </div>`,...(L=(B=d.parameters)==null?void 0:B.docs)==null?void 0:L.source}}};var E,F,M;p.parameters={...p.parameters,docs:{...(E=p.parameters)==null?void 0:E.docs,source:{originalSource:`() => <div style={{
  display: "flex",
  gap: 12,
  alignItems: "center"
}}>\r
  ...
  </div>`,...(ae=(ee=v.parameters)==null?void 0:ee.docs)==null?void 0:ae.source}}};var te,ne,oe;h.parameters={...h.parameters,docs:{...(te=h.parameters)==null?void 0:te.docs,source:{originalSource:`() => <div style={{
  display: "flex",
  gap: 12,
  flexWrap: "wrap"
}}>\r
  ...
  </div>`,...(oe=(ne=h.parameters)==null?void 0:ne.docs)==null?void 0:oe.source}}};var re,ie,se;g.parameters={...g.parameters,docs:{...(re=g.parameters)==null?void 0:re.docs,source:{originalSource:`() => <div style={{
  display: "flex",
  ...
  </div>`,...(ue=(me=x.parameters)==null?void 0:me.docs)==null?void 0:ue.source}}};var ve,he,ge;c.parameters={...c.parameters,docs:{...(ve=c.parameters)==null?void 0:ve.docs,source:{originalSource:`() => <div style={{
  display: "flex",
  gap: 12,
  flexWrap: "wrap"
}}>\r
