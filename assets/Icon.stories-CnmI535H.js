import{j as e}from"./jsx-runtime-DF2Pcvd1.js";import{I as a}from"./Icon-CQ1yD0uX.js";import"./index-B2-qRKKC.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./iframe-3Q35QAIm.js";const N={title:"DataDisplay/Icon",component:a,tags:["autodocs"],argTypes:{name:{control:"text"},variant:{control:{type:"radio"},options:["regular","bold","solid"]},size:{control:"number"},color:{control:"color"},ariaLabel:{control:"text"},lazy:{control:"boolean"}}},r=j=>e.jsx(a,{...j});r.args={name:"AddCircleIcon",variant:"regular",size:32,ariaLabel:"Add"};r.parameters={docs:{source:{code:'<Icon name="AddCircleIcon" variant="regular" size={32} ariaLabel="Add" />'}}};const i=()=>e.jsxs("div",{style:{display:"flex",gap:24,alignItems:"center"},children:[e.jsx(a,{name:"AddCircleIcon",variant:"regular",size:32,ariaLabel:"Add"}),e.jsx(a,{name:"AddCircleIcon",variant:"bold",size:32,ariaLabel:"Add"}),e.jsx(a,{name:"AddCircleIcon",variant:"solid",size:32,ariaLabel:"Add"})]});i.parameters={docs:{source:{code:`<Icon name="AddCircleIcon" variant="regular" />
